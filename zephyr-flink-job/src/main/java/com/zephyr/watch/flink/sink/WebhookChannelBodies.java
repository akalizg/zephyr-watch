...
/**
 * Builds channel-specific JSON bodies for inbound alert webhooks.
 * GENERIC keeps the legacy {@link AlertEvent} JSON; WeCom / DingTalk use each vendor's robot schema.
 */
public final class WebhookChannelBodies {
    ...
    /** Normalized channel key ({@code WECOM} / {@code DINGTALK} / {@code GENERIC} / …). */
    ...
    /** JSON string literal (quoted) with minimal escaping for control in markdown. */
